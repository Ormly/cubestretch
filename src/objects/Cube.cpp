...
void Cube::updateVertices()
{
    ...
    {
        //###cube###
        centerX - m_halfSideLength + gap, centerY - m_halfSideLength + gap, centerZ + m_halfSideLength - gap, //0 front bottom left
        cubeColorX, cubeColorY, cubeColorZ,
        centerX + m_halfSideLength - gap, centerY - m_halfSideLength + gap, centerZ + m_halfSideLength - gap, //1 front bottom right
        cubeColorX, cubeColorY, cubeColorZ,
        centerX + m_halfSideLength - gap, centerY + m_halfSideLength - gap, centerZ + m_halfSideLength - gap, //2 front top right
        cubeColorX, cubeColorY, cubeColorZ,
        centerX - m_halfSideLength + gap, centerY + m_halfSideLength - gap, centerZ + m_halfSideLength - gap, //3 front top left
        cubeColorX, cubeColorY, cubeColorZ,
        centerX - m_halfSideLength + gap, centerY - m_halfSideLength + gap, centerZ - m_halfSideLength + gap, //4 back bottom left
        cubeColorX, cubeColorY, cubeColorZ,
        centerX + m_halfSideLength - gap, centerY - m_halfSideLength + gap, centerZ - m_halfSideLength + gap, //5 back bottom right
        cubeColorX, cubeColorY, cubeColorZ,
        centerX + m_halfSideLength - gap, centerY + m_halfSideLength - gap, centerZ - m_halfSideLength + gap, //6 back top right
        cubeColorX, cubeColorY, cubeColorZ,
